...
OPTIMIZE_SEARCH_OPTIONS = (OPTIMIZE_SEARCH_FAST, OPTIMIZE_SEARCH_BALANCED, OPTIMIZE_SEARCH_MAX)
DEFAULT_OPTIMIZE_SEARCH = OPTIMIZE_SEARCH_BALANCED
OPTIMIZE_SEARCH_EVALUATION_BUDGETS = {
    OPTIMIZE_SEARCH_FAST: 700,
    OPTIMIZE_SEARCH_BALANCED: 2200,
    OPTIMIZE_SEARCH_MAX: 20_000,
}
