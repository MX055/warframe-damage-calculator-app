...
OPTIMIZE_SEARCH_FAST = "Fast"
OPTIMIZE_SEARCH_BALANCED = "Balanced"
OPTIMIZE_SEARCH_THOROUGH = "Thorough"
OPTIMIZE_SEARCH_OPTIONS = (OPTIMIZE_SEARCH_FAST, OPTIMIZE_SEARCH_BALANCED, OPTIMIZE_SEARCH_THOROUGH)
DEFAULT_OPTIMIZE_SEARCH = OPTIMIZE_SEARCH_BALANCED
OPTIMIZE_SEARCH_EVALUATION_BUDGETS = {
    OPTIMIZE_SEARCH_FAST: 400,
    OPTIMIZE_SEARCH_BALANCED: 700,
    OPTIMIZE_SEARCH_THOROUGH: 2200,
}
